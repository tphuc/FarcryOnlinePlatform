...
const proxy = 'https://farcryonline.herokuapp.com/'
...
class ProfileForm extends Component{
    ...
    submitData = (username, password, new_password) => {
        ...
        axios.post(`${proxy}/api/auth/login`, JSON.stringify({username, password}), config)
        .then(res => 
            axios.put(`${proxy}/api/user/${store.getState().auth.user.id}/profile`, {password: new_password}, tokenConfig())
