...
function (_React$Component) {
  ...
  _createClass(Slider, [{
    ...
    value: function render() {
      ...
      var commonClasses = (_commonClasses = {}, _defineProperty(_commonClasses, classes.disabled, disabled), _defineProperty(_commonClasses, classes.jumped, !disabled && currentState === 'jumped'), _defineProperty(_commonClasses, classes.focused, !disabled && currentState === 'focused'), _defineProperty(_commonClasses, classes.activated, !disabled && currentState === 'activated'), _defineProperty(_commonClasses, classes.vertical, vertical), _defineProperty(_commonClasses, classes.rtl, theme.direction === 'rtl'), _commonClasses);
